...
amministratore e che la pagina sia stata chiamata con il metodo POST. Se almeno una delle tre
condizioni non viene soddisfatta, visualizza un alert con il corrispondente messaggio di errore.
Se non ci sono errori, procede con il cambio dell'abbonamento al socio selezionato effettuando sul
database le operazioni opportune. Se tutto è andato a buon fine, visualizza un alert che avverte
del successo dell'operazione e che, appena chiuso, reindirizza alla pagina di gestione.-->
<?php
